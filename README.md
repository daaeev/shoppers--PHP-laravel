...
- Выполнить команду `npm install && npm run dev/production` (`npm install; npm run dev/production` при использовании PowerShell)
...
- Обновить курс валют в админ панели (предварительно запустив демона на обработку очереди с именем, указанным в `config/exchange`)
...
- Работа с событиями Laravel
  ...
  TODO:
  - Сортировка товаров по цене, учитывая валюту цены
  - Оплата товара при помощи API интернет-эквайринга от Enot.io
